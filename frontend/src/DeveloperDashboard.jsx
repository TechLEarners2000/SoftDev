...
import { getIdeas, getIdeaDetail, addUpdate, updateIdea, getStats } from './api';
  ...
  return (
    <div style={styles.container}>
      <nav style={styles.navbar}>
        <h1 style={styles.logo}>Developer Workspace</h1>
      ...
      <div style={styles.content}>
        <div style={styles.statsGrid}>
          <div style={styles.statCard}>
            <h3 style={styles.statLabel}>Assigned Tasks</h3>
              ...
              <div key={idea.id} style={styles.ideaCard}>
                <div style={styles.ideaHeader}>
                  <div>
                    ...
                    <p style={styles.ideaCustomer}>Customer: {idea.user_name}</p>
                  </div>
            ...
            <div style={styles.modalContent} onClick={(e) => e.stopPropagation()}>
              ...
              {selectedIdea.updates && selectedIdea.updates.length > 0 && (
                <div style={styles.updates}>
                  <h3 style={styles.updatesTitle}>Progress History</h3>
              ...
              <form onSubmit={handleAddUpdate} style={styles.updateForm}>
                <h3 style={styles.formTitle}>Add Progress Update</h3>
                <textarea
                  ...
                  rows="4"
                />
                <button type="submit" style={styles.submitBtn}>Submit Update</button>
              </form>
            </div>
          </div>
        )}
